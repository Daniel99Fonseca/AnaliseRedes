...
Após a remoção das ligações selecionadas aleatóriamente pudémos verificar uma redução de **`r rem_nod`** na nova rede.
...
```{r echo=FALSE, fig.width=6, fig.height=3.5, fig.cap="Boxplot da distribuição de graus na Nova Rede", fig.pos='H', fig.align='center'}
