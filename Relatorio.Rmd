...
plot(graus_festa,
     ...
     main="Grau do nó vs Grau médio dos vizinhos")
...
```{r core28_plot, fig.width=4, fig.height=4, fig.cap="28-core da Rede da Festa", fig.pos='H', fig.align='center'}
...
```{r echo=FALSE, fig.width=4, fig.height=4, fig.cap="Os 10 nós com mais intermediação",fig.pos='H', fig.align='center'}
...
```{r echo=FALSE, fig.width=4, fig.height=4, fig.cap="O nó mais central",fig.pos='H', fig.align='center'}
...
O parâmetro de heterogeneidade mede o quão desigual é a distribuição de graus da rede.Para a rede gerada, o valor obtido foi de **`r round(heterogeneity_q1, 3)`**.
