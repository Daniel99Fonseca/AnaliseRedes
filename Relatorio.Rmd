...
Os coeficientes - local e global - da rede foi calculado através da função `transitivity()`, tendo sido obtido o valor de clustering médio de **`r round(clust_media, 3)`**.
