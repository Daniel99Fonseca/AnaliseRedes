---
title: "Relatório Análise de Redes"
output:
  pdf_document:
...
```{r echo=FALSE, fig.width=7, fig.height=4, fig.cap="Rede da Festa", fig.pos='H', fig.align='center'}
plot(g_festa, vertex.size=8, vertex.label=NA, edge.color="grey80", main="Rede da Festa")
```
...
```{r echo=FALSE, fig.width=7, fig.height=4, fig.cap="Distribuição dos graus", fig.pos='H', fig.align='center'}
# Histograma
...
```{r echo=FALSE, fig.width=7, fig.height=4, fig.cap="Boxplot Rede da Festa", fig.pos='H', fig.align='center'}
...
```{r echo=FALSE, fig.width=4, fig.height=4, fig.cap="Grau do nó vs Grau médio dos vizinhos", fig.pos='H', fig.align='center'}
