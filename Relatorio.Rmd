...
O valor fica novamente **negativo**, concluindo que a rede continua **desassortativa**, o que já era de se esperar, pq ao remover ligações numa rede seria estranho a rede tornar se assortativa. enquanto a maioria destes últimos não se conecta
...
abline(lm(knn_vals_q2 ~ graus_q2), col="red", lwd=2)
